...
import "../../../styles/ChatbotPage.css"; // Import styles
...
const Chatbot = () => {
  ...
  const handleSend = async () => {
    ...
    setInput("");
    try {
      const botResponse = await chatbot(input); // ✅ Use the function from student.js
      setMessages([...newMessages, { sender: "bot", text: botResponse }]);
    } catch (err) {
      console.error("Error sending message to chatbot:", err);
      setMessages([...newMessages, { sender: "bot", text: "Sorry, error from chatbot!" }]);
    }
    ...
    try {
      ...
      console.error("Error sending message to chatbot:", err);
      setMessages([...newMessages, { sender: "bot", text: "Sorry, error from Hugging Face!" }]);
    }
  };
